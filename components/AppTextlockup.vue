<template>
    <div class="textlockup">
        ...
        <div class="new">
            <slot name="new">{{ $translate('AppTextlockup.new') }}</slot>
        </div>
        <div class="sale">
            <slot name="sale">{{ $translate('AppTextlockup.sale') }}</slot>
        </div>
        <div class="collection">
            <slot name="collection">{{ $translate('AppTextlockup.collection') }}</slot>
        </div>
        <div class="details">
            <slot name="details">{{ $translate('AppTextlockup.details') }}</slot>
        </div>
    </div>
</template>
